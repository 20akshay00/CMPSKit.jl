leftgauge(Ψ::YangGaudinCMPS, args...; kwargs...) = leftgauge!(copy(Ψ), args...; kwargs...)
rightgauge(Ψ::YangGaudinCMPS, args...; kwargs...) = rightgauge!(copy(Ψ), args...; kwargs...)

function leftgauge!(Ψ::YangGaudinCMPS, C₀=one(Ψ.Q);
                    maxreorth=10,
...
function rightgauge!(Ψ::YangGaudinCMPS, C₀=one(Ψ.Q); kwargs...)
    if Ψ.gauge == :r
        U = one(Ψ.Q)
...
#
# function leftcanonical!(Ψ::YangGaudinCMPS, C₀ = one(Ψ.Q); maxreorth = 10, kwargs...)
